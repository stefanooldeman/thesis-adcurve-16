...
% Met de doelstelling omschreven in \ref{sec:doelstelling}. "Gegevens die Adcurve toont moeten altijd te verklaren zijn en overeenkomen met de werkelijkheid. Zodat gebruikers beslissingen kunnen maken op basis van correcte en actuele gegevens in Adcurve. Dit houdt in dat: 

% a) een nieuwe implementatie zorgt voor het up-to-date houden van statistieken. \newline
% b) data correcties tijdig worden verwerkt zodat gegevens altijd te verklaren zijn \newline
